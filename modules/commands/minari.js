...
const chatbot  =  new  Chatbot({name: "Minari", gender: "Najimi"});
 ...
 if(res === "My dear great botmaster, Abdul.") {
    api.sendMessage(`I made by master 𝐌𝐑..𝐀𝐁𝐃𝐔𝐋, also known as Aaryan`, event.threadID, event.messageID)
    return;
              }   
      if(res === "My birthplace is Abdul's laptop. What is your birthplace?") {
    ...
    return;
            ...
            if(res === "I was created by Abdul.") {
    api.sendMessage(`I was created by Abdul.`, event.threadID, event.messageID)
    return;
              }     
              
              if(res === "I obey 𝐌𝐑.𝐀𝐁𝐃𝐔𝐋.") {
