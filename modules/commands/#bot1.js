...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "")) {
     return api.sendMessage("𝐌𝐎𝐘𝐄 𝐌𝐎𝐘𝐄🙆‍♂️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("Hello, Hi, Bye bye. Ye sab ke alawa kuch bolna nhi ata Kya tumko Chalo Allah  Bolo", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "bye")) {return api.sendMessage("Ok Bye Jldi phirse Milenge  Allah Hafiz ❤️🙄", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
   ...
   if ((event.body.toLowerCase() == "baby") || (event.body.toLowerCase() == "babu")) {
     return api.sendMessage("️🙈🙉🙊han babu bollo me yahin hun..👩‍❤️‍💋‍👨", threadID);
   };

   if ((event.body.toLowerCase() == "bot owner") || (event.body.toLowerCase() == "bot admin")) {
     return api.sendMessage("My Owner AestHetic bOy  Abdul khan \nhttps://www.facebook.com/ghg.hhgkh?mibextid=ZbWKwL🖤", threadID);
   };
...
if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😀😀")) {
   ...
   if ((event.body.toLowerCase() == "😞") || (event.body.toLowerCase() == "😞😞")) {
     ...
     return api.sendMessage("WALIKUM ASSALAM...🇸🇦🇸🇦", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bot ka owner") || (event.body.toLowerCase() == "create you")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟💙🄰🄱🄳🅄🄻🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐌𝐫 𝐀𝐛𝐝𝐮𝐥. 𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :https://www.facebook.com/ghg.hhgkh?mibextid=ZbWKwL", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Mr Abdul khan ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Raha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
     return api.sendMessage("He is Abdul Babu. He Gives his name Mr Abdul everywhare", threadID);
   };

   if ((event.body.toLowerCase() == "@Mahi Noor") || (event.body.toLowerCase() == "@rani singh")) {
   ...
   if ((event.body.toLowerCase() == "Abdul kon h") || (event.body.toLowerCase() =="Mahi Noor kon h")) {
     return api.sendMessage("️Abdul or Mahi Noor ek dusre ki jan hai😍😍💞", threadID);
   };
